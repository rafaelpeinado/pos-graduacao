...
![Cálculo Viabilidade Financeira e Econômica](./assets/viabilidade-financeira.png)
...
![Ponto de Equilíbrio](./assets/equilibrio.png)
  ...
  * **PERÍODO DE PROJEÇÃO:**
    ...
    * **FORMULAÇÕES:**
      * Pegar esse fluxo de caixa a valor presente, pegando o valor de hoje descontando o valor de taxa que tem ao longo do tempo (somente dos anos explícitos)
        * Por exemplo, geramos 100 reais de fluxo de caixa no ano 1 com 10% ao ano, nós fazemos V = 100 / (1 + 0,1)<sup>1</sup> = 90,91 reais = valor presente do fluxo de taxa
